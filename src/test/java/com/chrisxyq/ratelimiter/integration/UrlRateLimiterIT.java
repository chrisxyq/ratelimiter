package com.chrisxyq.ratelimiter.integration;

import com.chrisxyq.ratelimiter.DistributedUrlRateLimiter;
import com.chrisxyq.ratelimiter.MemoryUrlRateLimiter;
import com.chrisxyq.ratelimiter.UrlRateLimiter;
import com.chrisxyq.ratelimiter.env.PropertyConstants;
import com.chrisxyq.ratelimiter.env.RedisConfig;
import com.chrisxyq.ratelimiter.env.ZookeeperConfig;
...
public class UrlRateLimiterIT {
  ...
  private static final String ZK_PATH = "/com/chrisxyq/ratelimit";
