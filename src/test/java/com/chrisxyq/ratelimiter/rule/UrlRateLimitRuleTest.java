...
public class UrlRateLimitRuleTest {
  ...
  public void testAddRule() throws InvalidUrlException {
    ...
    List<UniformRuleConfigMapping.UniformRuleConfig> configs = new ArrayList<>();
    List<ApiLimit> limits1 = Arrays.asList(new ApiLimit[] {l2, l3});
    List<ApiLimit> limits2 = Arrays.asList(new ApiLimit[] {l5, l6});
    configs.add(new UniformRuleConfigMapping.UniformRuleConfig("app1", limits1));
    configs.add(new UniformRuleConfigMapping.UniformRuleConfig("app2", limits2));
